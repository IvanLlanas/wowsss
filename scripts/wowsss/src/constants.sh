...
#  _ansi_bg_cyan_light="\e[106m"
   ...
   cons_msg_wowsss_checking_updates="Checking for <b>WoWSSS</b> updates..."
   cons_msg_wowsss_update_available="An update for <b>WoWSSS</b> is available."
   cons_msg_wowsss_new_version_available="There is a new <b>WoWSSS</b> version available."
   cons_qst_install_update="  Install update [<b>Y</b>/n]? "
   cons_msg_updating="Updating..."
   cons_msg_skipping="Skipping..."
   cons_error_wowsss_updating="Error updating <b>WoWSSS</b>."
   cons_msg_wowsss_updated="<b>WoWSSS</b> updated. You may restart it."
   cons_msg_restarting="Restarting..."
   ...
   cons_lit_info_temp_dir="     Temporary directory"
   ...
   cons_url_wotlk_data="https://github.com/IvanLlanas/wotlk-server-data-files/releases/download/v19/data.7z"
...
>>>>>>> parent of 04bf1ea (Enabled mouse scrolling and scroll bar history scrolling for screen sessions (authserver and worldserver).)
...
function define_constants_2 ()
{
   ...
   cons_msg_restore_db_3="   These scripts must be placed in directory <b>$var_dir_sql</b>."
   ...
   cons_msg_restore_db_8="   <b>Current database contents will be OVERWRITTEN !!!</b></b>"
   cons_msg_restore_db_9="   MySQL/<b>$var_db_user</b> password will be manually required for each database."
